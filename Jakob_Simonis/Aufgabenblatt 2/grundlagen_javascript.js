...
//Objekt fuer Bewertung mit Durschnittsfunktion
...
function zufall() {
    ...
    for(var i = 1; i<=20; i++) {            //Schleife für Zufallszahl
        random = getRandomInt(5);           //Aufruf der Zufallsfunktion
